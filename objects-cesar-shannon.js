...
/*
Using console.log() we used dot notation to access the object, then the key of firstName in order to print the string "Arthur".
*/
...
/*
Write a code that would insert the key:value pair of homePlanet: 'Earth'
You can insert the new data by using dot notation with the name of the object.newKey = newValue
*/
